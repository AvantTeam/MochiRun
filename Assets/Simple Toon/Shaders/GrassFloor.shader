Shader "Simple Toon/Grass Floor"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed c = smoothstep(_LBound, _UBound, i.worldNormal.y);
				fixed4 shadecol = _DarkColor;
				fixed4 litcol = ColorBlend(_Color * (1.0 - c) + _TopColor * c, _LightColor0, _AmbientCol);
